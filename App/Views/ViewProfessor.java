...
public class ViewProfessor {
    ...
    public void telaIncial(Professor prof){
        ...
        do {
            ...
            System.out.println("4 - Consultar times com nota maior que 8\n5 - Encerrar competição\n6 - Consultar vencedor");
    ...
    public void encerrarCompeticao(){
        int opt;
        do{
            System.out.println("ATENÇÃO: ESSA OPÇÃO VAI ZERAR A NOTA DE TODOS OS TIMES QUE AINDA NÃO TIVERAM SUA NOTA ATRIBUIDA. VOCÊ TEM CERTEZA DISSO?");
